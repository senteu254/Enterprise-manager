...
$sql = "SELECT debtortrans.trandate,
							...
							debtortrans.rate,
							invtext
						FROM debtortrans WHERE debtortrans.type=11
...
$printer -> text("Credit No: ".$FromTransNo."\n");
//if($myrow['invtext'] !=""){
...
$DisplayTotal = locale_number_format(abs($myrow['ovgst']+$myrow['ovamount']),2);

$printer -> text(_strlen2("TOTAL CREDIT",$DisplayTotal)."\n");
$printer -> setEmphasis(false); // Reset
$printer -> text("------------------------------------------------\n");
$printer -> text(_strlen2("Credit",$DisplaySubTot)."\n");

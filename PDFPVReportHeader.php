...
$pdf->addTextWrap(0, $Page_Height-$Top_Margin-80, $Page_Width, 14,'Payment Voucher Report', 'center');
...
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin-20,$YPos,100,$FontSize, _('VID No'));
$LeftOvers = $pdf->addTextWrap(60,$YPos,85,$FontSize, _('Priority'));
$LeftOvers = $pdf->addTextWrap(110,$YPos,300,$FontSize, _('Ref No.'),'left');
$LeftOvers = $pdf->addTextWrap(210,$YPos,300,$FontSize, _('Payee Name'),'left');
$LeftOvers = $pdf->addTextWrap(410,$YPos,300,$FontSize, _('Total'),'left');
$LeftOvers = $pdf->addTextWrap(475,$YPos,300,$FontSize, _('Level(Stage)'),'left');

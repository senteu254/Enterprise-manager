...
$pdf->addText($XPos-10, $YPos-25,$FontSize, _('Department  :').' '.$myrow['dep']);
...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Doctor'));
$LeftOvers = $pdf->addTextWrap(120,$YPos,85,$FontSize, _('Date of visit'));
$LeftOvers = $pdf->addTextWrap(200,$YPos,300,$FontSize, _('Diagnosis'),'left');
$LeftOvers = $pdf->addTextWrap(400,$YPos,300,$FontSize, _('Prescription'),'left');

...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin-30,$YPos,100,$FontSize, _('Personal No'),'left');
$LeftOvers = $pdf->addTextWrap(60,$YPos,85,$FontSize, _('Name'),'center');
$LeftOvers = $pdf->addTextWrap(120,$YPos,300,$FontSize, _('Department'),'left');
$LeftOvers = $pdf->addTextWrap(280,$YPos,100,$FontSize, _(' Type'),'left');
$LeftOvers = $pdf->addTextWrap(420,$YPos,85,$FontSize, _(' Date'),'left');
$LeftOvers = $pdf->addTextWrap(520,$YPos,300,$FontSize, _(' Brief'),'left');

// Draws a box with round corners around line items:
$pdf->RoundRectangle(
	$Left_Margin-30,// RoundRectangle $XPos.
	$YPos+$FontSize+5,// RoundRectangle $YPos.
	$Page_Width-$Left_Margin-$Right_Margin+50,// RoundRectangle $Width.
...
$pdf->line($Page_Width-$Right_Margin+20, $LineYPos, $Left_Margin-30, $LineYPos);

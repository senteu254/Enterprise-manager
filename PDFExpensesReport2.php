	...
	nobble the invoice reprints */
			...
			if (DB_error_no()!=0 OR DB_num_rows($result)==0){
				...
				while ($myrow2=DB_fetch_array($result)){
				 ...
				 $LeftOvers = $pdf->addTextWrap($Left_Margin+0,$YPos,95,$FontSize,$myrow2['voted_Item']);
				 $LeftOvers = $pdf->addTextWrap($Left_Margin+51,$YPos,150,$FontSize,$myrow2['Votehead']);
			...
			$pdf->line($Left_Margin+51, $TopOfColHeadings+12,$Left_Margin+51,$Bottom_Margin+(1.6*$line_height));
		...
		$pdf->OutputD($_SESSION['DatabaseName'] . '_Expenses Report_.pdf');

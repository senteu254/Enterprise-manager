...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Personal No'),'left');
$LeftOvers = $pdf->addTextWrap(90,$YPos,40,$FontSize, _('Name'),'center');
$LeftOvers = $pdf->addTextWrap(130,$YPos,120,$FontSize, _('Department'),'left');
$LeftOvers = $pdf->addTextWrap(280,$YPos,415,$FontSize, _('Property'),'left');
$LeftOvers = $pdf->addTextWrap(380,$YPos,530,$FontSize, _('issue Date'),'left');
$LeftOvers = $pdf->addTextWrap(440,$YPos,645,$FontSize, _('Return Date'),'left');
$LeftOvers = $pdf->addTextWrap(500,$YPos,760,$FontSize, _('Estimate Cost'),'left');

...
/**********************************************************************Financial year*********************************************************************************************************/
echo'<td>Financial Year End</td><td>
<select name="Yearend">';echo'<option value="' .  Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],-1)) . '">' .  Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],-1)) . '</option>';			   

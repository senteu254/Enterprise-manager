...
/*$_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->tax/(100+$_SESSION['PaymentDetail' . $identifier]->tax) * ($_SESSION['PaymentDetail' . $identifier]->Amount_Total)),2));
...
################################################################## finance tax#################################################################################
 if ($_SESSION['PaymentDetail' . $identifier]->tax==6) {
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->Amount_Total*(16/116) * (6/16)),2));
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 
 }else if ($_SESSION['PaymentDetail' . $identifier]->tax == 8){
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->Amount_Total*(8/108) * (6/8)),2));
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 

 }else if ($_SESSION['PaymentDetail' . $identifier]->tax==5) {
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->Amount_Total*(5/100)),2));
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 
 }else if ($_SESSION['PaymentDetail' . $identifier]->tax==3) {
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->Amount_Total*(3/100)),2));
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 
 }else if ($_SESSION['PaymentDetail' . $identifier]->tax==10) {
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += (round(($_SESSION['PaymentDetail' . $identifier]->Amount_Total*(10/100)),2));
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 
 }else if($_SESSION['PaymentDetail' . $identifier]->tax==0) {
   $_SESSION['PaymentDetail' . $identifier]->TaxTotals += 0;
   $_SESSION['PaymentDetail' . $identifier]->AmountPaid = ($_SESSION['PaymentDetail' . $identifier]->Amount_Total) - ($_SESSION['PaymentDetail' . $identifier]->TaxTotals); 
 }
...
/*============================================================================================================================================*/
$SQL = "INSERT INTO votepaymenttrans ( `RefNo`, `VoteCode`, `BankAcc`, `SuppNo`, `Amount`,Fy) ";
...
/*============================================================================================================================================*/
/*============================================================================================================================================*/
$SQL = "INSERT INTO cash (`type`,VoucherID,Account, date,`descs`, `debit`, `credit`) ";
			$SQL = $SQL . "VALUES (22,
			...
			$SQL = "INSERT INTO paidtax (`taxed_from`,tax_percentage,amount,transdate) ";
			$SQL = $SQL . "VALUES ('" . $_SESSION['PaymentDetail' . $identifier]->SupplierID . "',
...
// End select Tag
	...
	echo '<tr>
			...
			<td><input type="text"  required="required" name="Cheque" maxlength="12" size="12" /></td>
		</tr>';
...
$Total_Pay = $_SESSION['PaymentDetail' . $identifier]->PV_Total-$tax;*/
		echo '<tr>
				...
				<td><input type="text" required="required" name="GLAmount" maxlength="12" size="12" class="number" value="' .  $_SESSION['PaymentDetail' . $identifier]->AmountPaid . '" /></td>
	</tr>';
	echo '<tr>
	<td>' . _('Tax') . ' (' . $_SESSION['PaymentDetail' . $identifier]->tax . '%) (Posted to Account):</td>
	<td><input type="text" required="required" name="tax" maxlength="12" size="12" class="number" value="' .  $_SESSION['PaymentDetail' . $identifier]->TaxTotals . '" /></td>
			</tr>';
	} else {

<?php
   ...
   /**********************************************************************/
	...
	DB_query("INSERT INTO `funds_allocations`(date,accountcode,votecode,voted_Item,allocated_Fund,Financial_Year)VALUES ('". date('Y-m-d') ."','". $_POST['SelectedAccount'] ."','" .$_POST['Votecode']. "','" .$_POST['Votecode']. "','$allocated_Fund','$Yearend')"); 
	...
	<tr><td>Financial Year End</td><td><select name="Yearend">';
             ...
             //  echo'<option value="' .  Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],-1)) . '">' .  Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],-1)) . '</option>';
	...
	// echo'<option value="'.  Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],+1)) . '" selected="true">' .Date($_SESSION['DefaultDateFormat'],YearEndDate($_SESSION['YearEnd'],+1)) . '</option>';
    ...
    $sql = "SELECT * FROM voteheadmaintenance ORDER BY VoteCode";

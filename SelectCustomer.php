...
/* $Id: SelectCustomer.php 6941 2014-10-26 23:18:08Z daintree $*/
...
if ($_SESSION['CustomerID'] != '' AND !isset($_POST['Search']) AND !isset($_POST['CSV'])) {
	...
	echo '<a href="' . $RootPath . '/ReverseCustomerPayment.php?DebtorNo=' . $_SESSION['CustomerID'] . '&amp;BranchNo=' . $_SESSION['BranchCode'] . '">' . _('Reverse Customer Payment') . '</a><br />';
	echo '</td><td valign="top" class="select">';
	...
	echo '<a href="' . $RootPath . '/UpdateCustomerBalance.php?DebtorNo=' . $_SESSION['CustomerID'] . '">' . _('Add/Modify/Delete Customer Balance') . '</a><br />';

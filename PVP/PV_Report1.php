...
######################################################################################
	...
	echo '<input name="FormID" type="hidden" value="'.$_SESSION['FormID'].'" />';
		$SQL2 = "SELECT * FROM pvlevel ORDER BY levelcode";
...
<?php
	...
	$print ='<a href="PDFPaymentVoucherReport.php?level='.$_POST['PV_Level'].'"><button type="button" class="btn btn-default"><i class="fa fa-print"></i> Print PV Report</button></a>';
	 echo $print; 
?>

...
//echo '<form action="'. htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') . '?Application=PVM&Ref=default&Link=Initiate_PV" method="post">';
...
echo '<a href="' . $RootPath . '/index.php?Application=PVM&Ref=default&Link=Initiate_PV">' . _('Back to Payment Voucher') . '</a>';
echo'<br>';
echo'<br>';
...
######################################################################################
echo '<form method="post" name="form" action="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '?Application=PVM&Ref=default&Link=Initiate_PV&identifier='.$identifier.'" id="form">
	<table class="table">
		<tr>';
...
echo '<tr>
	...
	echo '<tr>
			...
			<td><input type="hidden" name="trans[]" value="'.$transno.'" /><input type="text" size="35" maxlength="55" autofocus="autofocus" name="particulars[]" value="'.$particulars.'" /></td>
			...
			echo '<td width="20" height="20"><a href="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '?Application=PVM&Ref=default&Link=Initiate_PV&identifier='.$identifier . '&amp;DelPay=' . $Line->LineNumber . '" onclick="return confirm(\'' . _('Are You Sure?') . '\');"><span class="glyphicon glyphicon-trash"></span></a></td>';
		echo '</tr>';

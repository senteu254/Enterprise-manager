...
<td>Proffesianal.Fee(5%)</td>
 ...
 /* echo'<tr><td>Witholding Tax(2%)</td><td><input type="checkbox" style="width:25px; height:25px;" class="form-control" name="tax[]" unchecked="true" value="2"></td>
...
/*echo'<td><select name="tax" required="required">
		  ...
		  <option value="2">Withholding (2%)</option>
	   </select>
</td>';*/
	echo'</tr>';
echo '<tr>

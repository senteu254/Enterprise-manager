...
If (!isset($_GET['id']) || $_GET['id']==""){
        $Title = _('Select Civilian Off-Duty To Print');
        include('includes/header.inc');
        echo '<div class="centre">
				<br />
				<br />
				<br />';
        prnMsg( _('Select a Civilian Off-Duty to Print before calling this page') , 'error');
        echo '<br />
				<br />
				<br />
				...
				<tr>
					<td class="menu_group_item">
						<ul><li><a href="index.php?Application=HR&Ref=OffAppAll' . _(' Civilian Off-Duty All Approve') . '</a></li>
						</ul>
					</td>
				</tr>
				</table>
...
$ErrMsg = _('There was a problem retrieving the Civilian Off-Duty header details for this Vacation Number') . ' ' . $_GET['id'] . ' ' . _('from the database');
$sql = "SELECT *,b.emp_id as id FROM off_log a
...
if (DB_num_rows($result)==0){
	$Title = _('Print Civilian Off-Duty Request Error');
	include('includes/header.inc');
	 echo '<div class="centre">
			<br />
			<br />
			<br />';
	prnMsg( _('Unable to Locate Civilian Off-Duty Number') . ' : ' . $_GET['id'] . ' ', 'error');
	echo '<br />
			<br />
			<br />
			<table class="table_index">
			<tr>
				<td class="menu_group_item">
					<ul><li><a href="index.php?Application=HR&Ref=OffAppAll">' . _(' Civilian Off-Duty All Approve') . '</a></li></ul>
				</td>
			</tr>
			</table>
			</div>
...
$pdf->addInfo('Title', _('Civilian Off-Duty') );
$pdf->addInfo('Subject', _('Civilian Off-Duty') . ' ' . $_GET['id']);
$FontSize = 12;
$line_height = 12;// Recommended: $line_height = $x * $FontSize.

	/*Yes there are line items to start the ball rolling with a page header */
	include ('PDFOFFHeader.php');

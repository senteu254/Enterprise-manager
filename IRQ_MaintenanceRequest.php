...
require_once('includes/session.inc');
							...
							$view = (isset($_GET['Ref']) && $_GET['Ref'] != '') ? $_GET['Ref'] : '';
								...
								case 'Create-Request' :
									...
									$subtitle ='Create New Maintenance Request';
							...
							INNER JOIN irq_maintenance e ON a.requestid = e.maintenanceid
							WHERE draft=1 AND initiator = '".$_SESSION['UserID']."' AND closed=0";
							$result= mysqli_query($conn,$query) or die (mysqli_error($conn));

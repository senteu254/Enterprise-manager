	...
	nobble the invoice reprints */
		...
		header('location:index.php?Application=IRQ2');
				...
				while ($myrow2=DB_fetch_array($result)) {
					...
					$LeftOvers = $pdf->addTextWrap($Left_Margin+100,$YPos,351,$FontSize,$myrow2['longdescription'],'left');
			...
			$pdf->line($Left_Margin+97, $TopOfColHeadings+12,$Left_Margin+97,$Bottom_Margin+(7*$line_height));

			/* Print a column vertical line */
			$pdf->line($Left_Margin+450, $TopOfColHeadings+12,$Left_Margin+450,$Bottom_Margin+(7*$line_height));
			
			/* Print a column vertical line */
			$pdf->line($Left_Margin+510, $TopOfColHeadings+12,$Left_Margin+510,$Bottom_Margin+(7*$line_height));

			/* Print a column vertical line */
			$pdf->line($Left_Margin+580, $TopOfColHeadings+12,$Left_Margin+580,$Bottom_Margin+(7*$line_height));

			/* Print a column vertical line */
			
			$pdf->line($Left_Margin+617, $TopOfColHeadings+12,$Left_Margin+617,$Bottom_Margin+(7*$line_height));
			
			/* Print a column vertical line */

			$pdf->line($Left_Margin+700, $TopOfColHeadings+12,$Left_Margin+700,$Bottom_Margin+(7*$line_height));

			/* Rule off at bottom of the vertical lines */
			$pdf->line($Left_Margin, $Bottom_Margin+(7*$line_height),$Page_Width-$Right_Margin,$Bottom_Margin+(7*$line_height));
...
$tit[] = $title['approver_name'];
			...
			$YPos+=26;
				...
				$pdf->line($Left_Margin, $Bottom_Margin+(6*$line_height)+5,$Page_Width-$Right_Margin,$Bottom_Margin+(6*$line_height)+5);

...
<table>
  <tr>
    <th colspan="7"><h4>Maintenance Service Requisition</h4></th>
  </tr>
  <tr>
   ...
   $progress = 100;
	...
	echo '<td><center><a rel="facebox" href="IRQ/Follow_Up_View_Maintenance.php?id='. $myrow['requestid'] .'" title="View More" target="_parent">'. sprintf("%04d", $i) .'</a></center></td>
	<td><center>'. $myrow['cardno'].'</center></td>
	<td>'. $myrow['description'] .'</td>
	<td>'. $myrow['doc_name'] .'</td>
	<td><center>'. ConvertSQLDate($myrow['breakdowndate']).' '. date("h:i:s A",strtotime($myrow['breakdowndate'])) .'</center></td>

...
$comment= mysqli_real_escape_string($conn,$comm);
		...
		$_SESSION['msg'] = '<ul class="states"><li class="succes">' . _('Success: Maintenance Requisition No. '). $id . ' ' . _('has been appoved'). '</li></ul>';
		header('location:../IRQ_MaintenanceRequest.php?Ref=Inbox');
		}else{
$HSQL="INSERT INTO irq_authorize_state (requisitionid,
											level,
											approvaldate,

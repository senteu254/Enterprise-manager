...
$query="SELECT * FROM irq_request z 
	...
	$row = mysqli_fetch_array($result);
		...
		<td align="left" colspan="2">'.$row['transport_type'].'</td>
		</tr><tr>
		<th>Destination</th>
		<td align="left" colspan="2">'.$row['destination'].'</td>
		</tr><tr>
		<th>Nature of Duty</th>
		<td align="left" colspan="2">'.$row['nature_of_duty'].'</td>
		</tr><tr>

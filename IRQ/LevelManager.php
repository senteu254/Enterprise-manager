...
$result=mysqli_query($conn,"DELETE FROM irq_approvers WHERE approver_id='" .$appid. "'");
if($result==true){
...
<ul id="tabs">
    <li><a <?php echo ($tab==1)? 'class="current"' : ''; ?> href="<?php echo $link; ?>?Ref=Manage-Tasks&Tab=1">Manage Approvers</a></li>
    <li><a <?php echo ($tab==2)? 'class="current"' : ''; ?> href="<?php echo $link; ?>?Ref=Manage-Tasks&Tab=2">Documents</a></li>
</ul>
 <?php
 if($tab==1){
 ?>
...
<div style="width:80%" class="centre">
  ...
  ?>
	...
	<td width="20px"><a href="<?php echo $link.'?Ref=Manage-Tasks&Tab=1&Edit=1&Appid='.$myrow['approver_id']; ?>" title="Edit">Edit</a></td>
	<td width="30px"><a onclick="return confirm('Are you sure you want to Delete this Approver?');" href="<?php echo $link.'?Ref=Manage-Tasks&Tab=1&Del=1&Appid='.$myrow['approver_id']; ?>" title="Delete">Delete</a></td>
  </tr>
  <?php
  }
  ?>
...
<div id="php" class="tab-section">
	...
	<table>
	<tr>
    <th colspan="3"><h4>List of Documents Commonly Used</h4></th>
  </tr>
  <tr>
  ...
  ?>
	...
	<td width="100px"><a href="<?php echo $link; ?>?Ref=Manage-Tasks&Tab=2&Doc=<?php echo $myrow['doc_id']; ?>" title="Edit">Edit WorkFlow</a></td>
  </tr>
  <?php
  }
  ?>
...
<table style="width:500px">
  ...
  <tr>
	...
	echo '<a style="text-decoration:none;" href="IRQ/Add_Level.php?Doc=' .$id .'&AppId='.$myrow['level_id'].'" rel="facebox"><div class="process">'.$myrow['approver_name'].'</div></a>';
	echo "<div class=arrow></div>";
	}
	...
	if($end==1){
	if($decision==1){
	echo '<a style="text-decoration:none;" href="IRQ/Add_Level.php?Doc=' .$id .'&AppId='.$lev.'" rel="facebox"><div class="process">'.$appr.'</div></a>';
	echo "<div class=arrow></div>";
	echo "<div class=decision></div>";
	echo '<div style="width:50px; border-radius:30px; padding-top:15px; font-size:10px; height:27px;" class="start">Approved</div>';
	}else{
	echo '<a style="text-decoration:none;" href="IRQ/Add_Level.php?Doc=' .$id .'&AppId='.$lev.'" rel="facebox"><div class="end">'.$appr.'</div></a>';
	}
	}else{
	echo '<a style="text-decoration:none;" href="IRQ/Add_Level.php?Doc='. $id .'" rel="facebox"><div class="addapp">Add Approver</div></a>';
	}
	}else{	
	echo '<a style="text-decoration:none;" href="IRQ/Add_Level.php?Doc='. $id .'" rel="facebox"><div class="addapp">start</div></a>';
	}
	?>

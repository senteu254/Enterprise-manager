...
$result=DB_query("SELECT 
						 ...
						 SUM(b.allocated_Fund) AS allocated_Fund2,
						 b.votecode,
						 b.suppliementary,
						 b.voted_Item,
						 e.Votehead,
     ...
     $Cur_Balance=($myrow['allocated_Fund2']-$myrow['commitments']);
	 $totalAlloc=($myrow['allocated_Fund2']+$myrow['suppliementary']);
	...
	echo"<td style=text-align:right>" .locale_number_format($myrow['allocated_Fund2'],2)."</font></td>";

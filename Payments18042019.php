...
if (isset($_POST['VoteHead']) AND $_POST['VoteHead']!=''){
	$_SESSION['PaymentDetail' . $identifier]->VoteCode = $_POST['VoteHead'];
}
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
...
echo '<tr>
		<td>' . _('Vote Head') . ':</td>
		<td><select name="VoteHead" autofocus="autofocus" required="required" title="' . _('Select the Vote Head account that the payment has been made from') . '" >';

...
while ($myrow=DB_fetch_array($Result)) {
	...
	echo '<tr>
			...
			<td>' . $ManagerName . '</td>
			<td><a href="MaintenanceComplete.php?id=' . $myrow['taskid'] .'" onclick="return confirm(\'' . _('Are you sure you wish to mark this maintenance task as completed?') . '\');">' . _('Mark Completed') . '</a></td>

...
$pdf->addInfo('Title', _('Raw Material Acceptance Report') );
$pdf->addInfo('Subject', _('Raw Material Acceptance Report') . ' ' . $_GET['id']);
$FontSize = 12;
...
// Prints 'Quotation' title:
	$tt = _('RAW MATERIAL ACCEPTANCE FORM');
...
$pdf->SetFont('');
$LeftOvers = $pdf->addTextWrap(350,$YPos,200,$FontSize, _('COUNTRY'),'left');
$pdf->SetFont('','B');
$LeftOvers = $pdf->addTextWrap(410,$YPos+1,200,$FontSize, $myrow['country'],'left');
$pdf->SetFont('');

$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos-13,100,$FontSize, _('CALIBRE'));
$pdf->SetFont('','B');
$LeftOvers = $pdf->addTextWrap(100,$YPos-13,200,$FontSize, $myrow['calibre']);
$pdf->SetFont('');
...
$pdf->line($Left_Margin+30, $YPos+27, $Left_Margin+30, $YPos-82);
$pdf->line($Left_Margin+130, $YPos+27, $Left_Margin+130, $YPos-82);
$pdf->line($Left_Margin+190, $YPos+10, $Left_Margin+190, $YPos-82);
$pdf->line($Left_Margin+250, $YPos+27, $Left_Margin+250, $YPos-82);
$pdf->line($Left_Margin+320, $YPos+10, $Left_Margin+320, $YPos-82);
$pdf->line($Left_Margin+390, $YPos+27, $Left_Margin+390, $YPos-82);
$pdf->line($Left_Margin+460, $YPos+27, $Left_Margin+460, $YPos-82);
//$pdf->line($Page_Width-$Right_Margin, $YPos+$FontSize+10, $Left_Margin, $YPos+$FontSize+10);
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,30,$FontSize, 'S/No', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+30,$YPos,100,$FontSize, 'Brass Lot No', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+145,$YPos+13,100,$FontSize, 'Strip Dimension', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+130,$YPos,100,$FontSize, 'Thickness', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+200,$YPos,100,$FontSize, 'Width', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+285,$YPos+13,100,$FontSize, 'Roller Diameter', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+270,$YPos,100,$FontSize, 'Outer', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+340,$YPos,100,$FontSize, 'Inner', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+410,$YPos,100,$FontSize, 'Hardness', 'left');
$LeftOvers = $pdf->addTextWrap($Left_Margin+480,$YPos,100,$FontSize, 'WT.', 'left');
...
$pdf->addTextWrap($Left_Margin+30,$YPos,100,$FontSize, $myx['lot'], 'left');
$pdf->addTextWrap($Left_Margin+130,$YPos,100,$FontSize, $myx['thickness'], 'left');
$pdf->addTextWrap($Left_Margin+200,$YPos,100,$FontSize, $myx['width'], 'left');
$pdf->addTextWrap($Left_Margin+270,$YPos,100,$FontSize, $myx['outerdim'], 'left');
$pdf->addTextWrap($Left_Margin+340,$YPos,100,$FontSize, $myx['innerdim'], 'left');
$pdf->addTextWrap($Left_Margin+410,$YPos,100,$FontSize, $myx['hardness'], 'left');
$pdf->addTextWrap($Left_Margin+480,$YPos,100,$FontSize, $myx['wt'], 'left');
$YPos -= 13;
$Lines += 13;
$i++;
}	

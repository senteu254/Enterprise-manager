	...
	nobble the invoice reprints */
		...
		if (DB_error_no()!=0) {
			...
			$sql = "SELECT stockmaster.stockid,
								...
								SUM(irq_procurementplanitems.quantity) as qty,
								SUM(irq_procurementplanitems.quantity2) as qty2,
								SUM(irq_procurementplanitems.quantity3) as qty3,
			...
			if (DB_error_no()!=0 OR DB_num_rows($result)==0) {
				...
				include('includes/PDFProcurementPlanHeaderGeneral.php');
				$FirstPage = False;

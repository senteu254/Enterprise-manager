...
$pdf->addText($XPos-10, $YPos+20,$FontSize, _('Department :').''.$myrow['description']);
$pdf->addText($XPos-10, $YPos+5,$FontSize,  _('Date   :').''.date("Y/m/d"));
$pdf->addText($XPos-10, $YPos-10,$FontSize, _('Expected Number of employees :').''.$myrow['dept']);
$pdf->addText($XPos-10, $YPos-25,$FontSize, _('Available Employees  :').''.$myrow['total']);
$pdf->addText($XPos-10, $YPos-40,$FontSize, _('Deviation  :').''.$diffm);
...
$pdf->RoundRectangle(
	...
	200+10+10+40,// RoundRectangle $Width.
...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Section'));
$LeftOvers = $pdf->addTextWrap(120,$YPos,85,$FontSize, _('No of Employees'));
$LeftOvers = $pdf->addTextWrap(200,$YPos,300,$FontSize, _('Deviation'),'left');

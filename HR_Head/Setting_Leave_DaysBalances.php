...
$ids = $id[$i];
if(isset($_POST['ob_'.$ids]) && $_POST['ob_'.$ids] !=""){
...
if($row['num'] >0){
$sql = "UPDATE leave_days_allocation SET opening_bal='".$_POST['ob_'.$ids]."' WHERE emp_id='".$ids."' AND year='".$_POST['selectedyear']."' AND leave_type='".$_POST['selectedtype']."'";
$qry = DB_query($sql,$ErrMsg);
}else{
$sql = "INSERT INTO leave_days_allocation (emp_id,leave_type,year,opening_bal)
					VALUE('".$ids."','".$_POST['selectedtype']."','".$_POST['selectedyear']."','".$_POST['ob_'.$ids]."')";
$qry = DB_query($sql,$ErrMsg);
}
}
}
...
<?php
			...
			<table style="width:100%" class="table table-hover table-striped">
                ...
                echo  '<tr>
                    ...
                    <td class="mailbox-star"><input type="hidden" name="ids[]" value="'.$rows['emp_id'].'"><input name="ob_'.$rows['emp_id'].'" type="text" style="width:80px" value="" /></td>

...
$startpoint = ($page * $per_page) - $per_page;
	...
	?>
              ...
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveTrash"><button type="button" title="Refresh" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
				<?php } ?>
                <div class="pull-right">
				<div class="btn-group">
				<?php
				echo pagination_inbox($sqlforPages,$per_page,$page,$url='?Application=HR&Ref=LeaveApp&Link=LeaveTrash&');
				?>
                  </div>
                  <!-- /.btn-group -->
                </div>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <table style="width:100%" class="table table-hover table-striped">
                  ...
                  echo '<tr>
                    ...
                    <td width="170" class="mailbox-name"><a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveTrashRead&LID='.$row['id'].'&L_Type='.$row['leave_type'].'">'.ucwords(strtolower($realname)).'</a></td>

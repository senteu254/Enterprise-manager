...
if(isset($_POST['Reject'])){
	...
	echo '<b style="color:#3300FF">Record(s) Rejected Successfully.</b>';
}
if(isset($_POST['Forward'])){
	...
	if($_POST['type_'.$id[$i]]==1){
		...
		$forward = "UPDATE leave_half_day SET ".$_POST['LevelCode']."='".date('Y-m-d H:m:s')."' WHERE half_id=".$LID."";	
		$welcome_viewed = DB_query($forward,$ErrMsg,$DbgMsg);
	}elseif($_POST['type_'.$id[$i]]>=3){
...
$startpoint = ($page * $per_page) - $per_page;
	...
	?>
              ...
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveInbox"><button type="button" title="Refresh" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
				<?php
				}
				?>
				...
				<div class="btn-group">
				<?php
				echo pagination_inbox($sqlforPages,$per_page,$page,$url='?Application=HR&Ref=LeaveApp&Link=LeaveInbox&');
				?>
                  </div>
                  <!-- /.btn-group -->
                </div>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <table style="width:100%" class="table table-hover table-striped">
                  ...
                  echo '<tr>
                    ...
                    <td width="170" class="mailbox-name"><a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveInboxRead&LID='.$row['id'].'&L_Type='.$row['leave_type'].'">'.ucwords(strtolower($realname)).'</a></td>

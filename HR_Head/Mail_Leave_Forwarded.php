...
$startpoint = ($page * $per_page) - $per_page;
						...
						$statement = " leave_annual,www_users,leave_types,leave_all_types,leave_approval_levels,employee,departments,section,chiefofficer
										...
										AND leave_annual.levelcheck>leave_approval_levels.levelcheck
										AND leave_approval_levels.levelcheck <>4
						...
						$statement2 = " leave_off_duty,www_users,leave_types,leave_approval_levels,employee,departments,section,chiefofficer
										...
										AND leave_approval_levels.leave_type=leave_types.id 
										AND leave_off_duty.levelcheck>leave_approval_levels.levelcheck
										AND leave_approval_levels.levelcheck <>3
						...
						$statement3 = " leave_half_day,www_users,leave_types,leave_approval_levels,employee,departments,section,chiefofficer
										...
										AND leave_approval_levels.leave_type=leave_types.id 
										AND leave_half_day.levelcheck>leave_approval_levels.levelcheck
										AND leave_approval_levels.levelcheck <>4
	...
	?>
              ...
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveForwarded"><button type="button" title="Refresh" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
				<?php } ?>
                <div class="pull-right">
				<div class="btn-group">
				<?php
				echo pagination_inbox($sqlforPages,$per_page,$page,$url='?Application=HR&Ref=LeaveApp&Link=LeaveForwarded&');
				?>
                  </div>
                  <!-- /.btn-group -->
                </div>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <table style="width:100%" class="table table-hover table-striped">
                  ...
                  echo '<tr>
                    ...
                    <td width="170" class="mailbox-name"><a href="index.php?Application=HR&Ref=LeaveApp&Link=LeaveForwardedRead&LID='.$row['id'].'&L_Type='.$row['leave_type'].'">'.ucwords(strtolower($realname)).'</a></td>

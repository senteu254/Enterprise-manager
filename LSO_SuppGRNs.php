...
$SQL = "SELECT grnbatch,
		...
		LEFT JOIN farmdescriptions ON lsogrns.itemcode=farmdescriptions.stockid
...
if (DB_num_rows($GRNResults)==0){
	...
	echo '<div class="centre"><p><a href="' . $RootPath . '/LSO_SelectOSPurchOrder.php?SupplierID=' . $_SESSION['SuppTrans']->SupplierID .'">' . _('Select Purchase Orders to Receive')  . '</a></p></div>';
	include('includes/footer.inc');
	exit;
}

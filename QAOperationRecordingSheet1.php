...
if (isset($_POST['Submit'])) {
	...
	if (isset($_POST['SelectedMeasureID']) AND $_POST['SelectedMeasureID']!='' AND $InputError !=1) {
		...
		if ( $myrow[0] > 0 ) {
			...
			if ( DB_num_rows($result) != 0 ) {
				...
				$sql[] = "UPDATE qarecordingsheet
					SET operationid='" . $_POST['opid'] . "', typeid='" . $_POST['typeid'] . "', sheetname='" . $_POST['MeasureName'] . "', max_limit='" . $_POST['max'] . "', min_limit='" . $_POST['min'] . "', graphs='".$_POST['graph']."'
					WHERE id = '" . $SelectedMeasureID . "'";
		...
		if ( $myrow[0] > 0 ) {
			...
			$sql = "INSERT INTO qarecordingsheet (operationid, typeid,sheetname,max_limit,min_limit,description,graphs)
					VALUES ('" . $_POST['opid'] ."','" . $_POST['typeid'] ."','" . $_POST['MeasureName'] ."','" . $_POST['max'] ."','" . $_POST['min'] ."','" . $_POST['description'] ."','".$_POST['graph']."')";
		}

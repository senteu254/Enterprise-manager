...
<div class="mailbox-read-message">
		...
		echo '</table>';
			...
			<center><button id="submit" name="SubmitReject" onclick="return myFunction();" class="btn btn-danger"><i class="fa fa-times"></i> Reject</button>&nbsp;&nbsp;&nbsp;
		...
		<div class="form-group">
		 			<div class="col-md-4">Start Date
							  <input autocomplete="off" type="text" class="date" alt="d/m/Y" name="StartDate" value="" id="form-control" required="" />
							  </div>
							...
							echo '</select>';
							  ...
							  <div class="col-md-4">End Date
							   <input autocomplete="off" type="text" class="date" alt="d/m/Y" name="EndDate" value="" id="form-control" required="" />
							   </div>
							   <div class="col-md-2">Time
							  <?php

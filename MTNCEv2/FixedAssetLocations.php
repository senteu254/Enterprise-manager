...
while ($myrow=DB_fetch_array($result)) {
	...
	echo '<td>' . $ParentRow['locationdescription'] . '</td>
		<td><a href="'.htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '?Application=FA&Link=AssetLocation&SelectedLocation='.$myrow['locationid'].'">' .  _('Edit') . '</a></td></tr>';
}

echo '</table>
	<br />';
echo '<form id="LocationForm" method="post" action="">
      <div>

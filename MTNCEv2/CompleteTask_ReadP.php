...
<div class="mailbox-read-message">
		...
		echo '</table>';
			...
			$sqlx= "SELECT *, TIME_TO_SEC(TIMEDIFF(enddate,startdate)) as diff, (SELECT caneditMP FROM www_users WHERE userid='".$_SESSION['UserID']."') as userauthorized FROM fixedassettasks
							WHERE requestid='" . $LID . "'";
			$resx = DB_query($sqlx);

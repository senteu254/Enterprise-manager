...
$tt = _('Half Day Permission  Report');
...
$pdf->addText($XPos-10, $YPos+20,$FontSize, _('Personal No :').''.$myrow['emp_id']);
...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Start Time'));
$LeftOvers = $pdf->addTextWrap(120,$YPos,85,$FontSize, _('End Time'));

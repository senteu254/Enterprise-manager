...
$pdf->addTextWrap(0, $Page_Height-$Top_Margin-80, $Page_Width, 14,'Employees Leave Report', 'center');
...
$LeftOvers = $pdf->addTextWrap(70,$YPos,85,$FontSize, _('Leave Type'));
$LeftOvers = $pdf->addTextWrap(200,$YPos,300,$FontSize, _('From Date'),'left');
$LeftOvers = $pdf->addTextWrap(300,$YPos,300,$FontSize, _('To Date'),'left');
//$LeftOvers = $pdf->addTextWrap(400,$YPos,300,$FontSize, _('From Date'),'left');
$LeftOvers = $pdf->addTextWrap(380,$YPos,300,$FontSize, _('Days'),'left');
$LeftOvers = $pdf->addTextWrap(440,$YPos,300,$FontSize, _('Status'),'left');
$LeftOvers = $pdf->addTextWrap(500,$YPos,300,$FontSize, _('Applied On'),'left');

...
Class Tender {
	...
	function save($db) {
		...
		if ($this->TenderId=='') {
			...
			if(isset($_SESSION['RFQReq_No']) && $_SESSION['RFQReq_No']!=""){
			$sql="SELECT level FROM irq_authorize_state WHERE requisitionid='" . $_SESSION['RFQReq_No'] . "'";
				$result=DB_query($sql);
				...
				$doc =1;
					$HSQL="INSERT INTO irq_authorize_state (requisitionid,
										...
										VALUES(
											...
											'Quotation Raised (Ref:" . $this->quotationNo . ")')";
		$insert=DB_query($HSQL);
			DB_query("UPDATE irq_request SET order_ref='Quotation Raised (Ref:" . $this->quotationNo . ")', closed=1 WHERE requestid='". $_SESSION['RFQReq_No'] ."'");

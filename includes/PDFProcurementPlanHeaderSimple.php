...
/*Print a vertical line */
$pdf->line($Left_Margin+350, $YPos+$line_height-7,$Left_Margin+350,$YPos-18);
...
$pdf->addText($Left_Margin+365, $YPos, $FontSize, _('Unit Cost'));
$pdf->addText($Left_Margin+450, $YPos, $FontSize, _('Quantity'));

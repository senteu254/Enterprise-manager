...
$FontSize =8;
		...
		$second='Suppliers Payments and Balances  ';
...
$grouptype = 'Group Type: All';
		...
		$FontSize =13;
		$pdf->addText($Page_Width - 275, $YPos-8, $FontSize, _($second), 'centre');
...
//$pdf->addText($Left_Margin+10, $YPos, $FontSize, _('SNo.'));
$pdf->addText($Left_Margin+1, $YPos, $FontSize, _('Order #'));
$pdf->addText($Left_Margin+50, $YPos, $FontSize, _('Invoice No.'));
$pdf->addText($Left_Margin+121, $YPos, $FontSize, _('RV No.'));
$pdf->addText($Left_Margin+330, $YPos, $FontSize, _('Date'));
$pdf->addText($Left_Margin+382, $YPos, $FontSize, _('Supplier Name'));
$pdf->addText($Left_Margin+590, $YPos, $FontSize, _('Amt of invoice'));
$pdf->addText($Left_Margin+664, $YPos, $FontSize, _('Amt payed'));
$pdf->addText($Left_Margin+725, $YPos, $FontSize, _('Balance'));

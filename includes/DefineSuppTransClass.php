...
Class SuppTrans {
	...
	function Add_Contract_To_Trans($ContractRef,$ContractNo, $Amount,$Narrative, $AnticipatedCost){
		if ($Amount!=0){
...
Class Contract {
	...
	function Contract ($Counter, $ContractRef,$ContractNo, $Amount,$Narrative,$AnticipatedCost){
		$this->Counter = $Counter;

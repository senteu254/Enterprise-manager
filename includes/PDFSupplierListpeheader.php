...
$FontSize =8;
		...
		$second='Suppliers based on Group Type ';
...
$pdf->addText($Left_Margin+5, $YPos, $FontSize, _('SNo.'));
$pdf->addText($Left_Margin+30, $YPos, $FontSize, _('Code'));
$pdf->addText($Left_Margin+66, $YPos, $FontSize, _('Supplier Name'));
$pdf->addText($Left_Margin+295, $YPos, $FontSize, _('Grouptype'));
$pdf->addText($Left_Margin+343, $YPos, $FontSize, _('Address1'));
//$pdf->addText($Left_Margin+495, $YPos, $FontSize, _('Address2'));
$pdf->addText($Left_Margin+550, $YPos, $FontSize, _('Telephone No.'));
$pdf->addText($Left_Margin+615, $YPos, $FontSize, _('Email Address'));

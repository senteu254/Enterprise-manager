...
$FontSize = 10;
	...
	$pdf->addText($Page_Width-180, $YPos-26, $FontSize, $myrow['planid']);
	$pdf->addText($Page_Width-268, $YPos-39, $FontSize, _('Date Submitted'));
	$pdf->addText($Page_Width-180, $YPos-39, $FontSize, ConvertSQLDate($myrow['Requesteddate']));
	$pdf->addText($Page_Width-268, $YPos-52, $FontSize, _('Financial Year'));
	$pdf->addText($Page_Width-180, $YPos-52, $FontSize, $myrow['year']);
	$pdf->addText($Page_Width-268, $YPos-65, $FontSize, _('Submitted By'));

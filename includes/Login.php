...
<div id="container">
	...
	<br />
	<span><?php echo _('User name').$_SESSION['LogPath']; ?>:</span><br />
	<input type="text" name="UserNameEntryField" required="required" autofocus="autofocus" autocomplete="off" maxlength="20" placeholder="<?php echo _('User name'); ?>" /><br />

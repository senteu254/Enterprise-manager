...
$FontSize =15;
       ...
       // $first='';
		...
		$second='Votebook Supplimentary Allocation Status';
		...
		$pdf->addText($Page_Width - 205, $YPos-45, $FontSize, _($status), 'centre');
...
//$FontSize=10;
$FontSize =13;
$pdf->addText($Left_Margin + 20, $YPos, $FontSize, _('FROM VOTE HEAD') . '');
$pdf->addText($Left_Margin+280, $YPos, $FontSize, _('TO VOTE HEAD') . '');
$pdf->addText($Left_Margin+600, $YPos, $FontSize, _('') . '');

$FontSize=8;
/*Print a vertical line */

/*Print a vertical line */
$pdf->line($Left_Margin+210, $YPos+$line_height-7,$Left_Margin+210,$YPos-18);
...
$pdf->addText($Left_Margin+0, $YPos, $FontSize, _(''));
$pdf->addText($Left_Margin+50, $YPos, $FontSize, _(''));
$pdf->addText($Left_Margin+255, $YPos, $FontSize, _(''));
$pdf->addText($Left_Margin+310, $YPos, $FontSize, _(''));
$pdf->addText($Left_Margin+435, $YPos, $FontSize, _('Original Amnt '));
$pdf->addText($Left_Margin+510, $YPos, $FontSize, _('Allocated'));
$pdf->addText($Left_Margin+575, $YPos, $FontSize, _('Total Amnt'));
$pdf->addText($Left_Margin+650, $YPos, $FontSize, _('Date'));
$pdf->addText($Left_Margin+720, $YPos, $FontSize, _('User Name'));

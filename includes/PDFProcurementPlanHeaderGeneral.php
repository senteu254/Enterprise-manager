...
$FontSize =15;
        ...
        $first=strtoupper($myrow['doc_name']);
		$second='For the Financial Year Ends';
		$pdf->addText($Page_Width - 265, $YPos, $FontSize, _($first), 'centre');
		$FontSize =13;
		$pdf->addText($Page_Width - 235, $YPos-18, $FontSize, _($second), 'centre');
		$pdf->addText($Page_Width - 200, $YPos-33, $FontSize, _('On '.$myrow['year']), 'centre');
...
$FontSize = 10;
	...
	$pdf->addText($Page_Width-260, $YPos-35, $FontSize, _('Cummulative Figures Per Item for all Departments'));
	$pdf->addText($Page_Width-260, $YPos-50, $FontSize, _('Printed Date'));
	$pdf->addText($Page_Width-180, $YPos-50, $FontSize, date('d/m/Y'));
	$pdf->addText($Page_Width-260, $YPos-65, $FontSize, _('Financial Year'));
	$pdf->addText($Page_Width-180, $YPos-65, $FontSize, $myrow['year']);


$pdf->addText($Page_Width-268, $YPos-103, $FontSize, _('Page'));
$pdf->addText($Page_Width-180, $YPos-103, $FontSize, $PageNumber);
...
$msq='Please Check the under-listed items';
...
/*Set up headings */
$FontSize=10;
//$pdf->addText($Left_Margin + 2, $YPos, $FontSize, _('Department/Office') . ':');
//$pdf->addText($Left_Margin+90, $YPos, $FontSize, strtoupper($myrow['description']));


/*Print a vertical line */

/*Print a vertical line */
$pdf->line($Left_Margin+470, $YPos+$line_height-7,$Left_Margin+470,$YPos-18);
...
$pdf->line($Left_Margin+470, $YPos+5,$Page_Width-$Right_Margin, $YPos+5);

$YPos -= 12;

$TopOfColHeadings = $YPos-10;
$pdf->addText($Left_Margin+600, $YPos+30, $FontSize, _('Distribution'));
$pdf->addText($Left_Margin+500, $YPos+15, $FontSize, _('1st Quarter'));
$pdf->addText($Left_Margin+600, $YPos+15, $FontSize, _('2nd Quarter'));
$pdf->addText($Left_Margin+700, $YPos+15, $FontSize, _('3rd Quarter'));
$pdf->addText($Left_Margin+5, $YPos, $FontSize, _('Item Code'));
$pdf->addText($Left_Margin+100, $YPos, $FontSize, _('Description'));
$pdf->addText($Left_Margin+284, $YPos, $FontSize, _('Unit Cost'));
$pdf->addText($Left_Margin+340, $YPos, $FontSize, _('Quantity'));
$pdf->addText($Left_Margin+400, $YPos, $FontSize, _('Total Cost'));
$pdf->addText($Left_Margin+470, $YPos, $FontSize, _('Qty'));
$pdf->addText($Left_Margin+510, $YPos, $FontSize, _('Amount'));
$pdf->addText($Left_Margin+570, $YPos, $FontSize, _('Qty'));
$pdf->addText($Left_Margin+610, $YPos, $FontSize, _('Amount'));
$pdf->addText($Left_Margin+670, $YPos, $FontSize, _('Qty'));
$pdf->addText($Left_Margin+710, $YPos, $FontSize, _('Amount'));

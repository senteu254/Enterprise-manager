...
$tt = _('NON-CONFORMING PRODUCTS RECORD FORM');
...
//$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('MACHINE'));
$pdf->SetFont('','B');
$LeftOvers = $pdf->addTextWrap(100,$YPos,200,$FontSize, $myrow['machine']);
$pdf->SetFont('');
$LeftOvers = $pdf->addTextWrap(350,$YPos,200,$FontSize, _('DATE'),'left');
$pdf->SetFont('','B');
$LeftOvers = $pdf->addTextWrap(400,$YPos,200,$FontSize, $myrow['date'],'left');
$pdf->SetFont('');
...
$pdf->SetFont('');
$LeftOvers = $pdf->addTextWrap(350,$YPos-13,300,$FontSize, _('LOT No'),'left');
$pdf->SetFont('','B');
$LeftOvers = $pdf->addTextWrap(400,$YPos-13,415,$FontSize, $myrow['lot'],'left');
$pdf->SetFont('');

...
if (isset($_POST['SearchContractors'])) {
	...
	echo '<br />
		...
		<br />';
 echo' </table>';
	echo'<table style="width:10px; font-size:12px;" class="selection table table-hover">';
	echo '<tr>
...
<div style="width:100%" class="centre">
	<table style="width:80%" class="selection table table-hover">
  <tr>
    <th colspan="2"><h4><?php echo 'Initiate Farm New Service'; ?></h4></th>
  </tr>
...
foreach ($_SESSION['FP']->LineItems as $LineItems) {
	...
	echo '<td>' . $k . '</td>
			...
			<td style=font-size:2pt><input type="text" size="9" maxlength="60" value="'.locale_number_format($LineItems->cost, $_SESSION['StandardCostDecimalPlaces']).'" name="cost" /></td>
			...
			<td><a href="'. htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') . '?Delete='.$LineItems->LineNumber.'&Application=FA2&Ref=default&Link=contract_service"">' . _('Delete') . '</a></td>
		</tr>';
}
echo '</table>
	<br />

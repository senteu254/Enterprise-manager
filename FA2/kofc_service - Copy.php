...
if (isset($_GET['Edit'])) {
	...
	echo '<table  style="width:25%;" class="selection table table-hover">';
	echo '<tr>
...
<div style="width:100%" class="centre">
	<table style="width:50%" class="selection table table-hover">
  <tr>
    <th colspan="2"><h4><?php echo 'Crop Production'; ?></h4></th>
  </tr>
...
//echo '<option selected="selected" value="">--Please Select Service Provider--</option>';
...
echo '<br />
	...
	<tr>
		<th colspan="12"><h4>' . _('Details of farm Production') . '</h4></th>
	</tr>
	<tr>
		<th>' .  _('Line Number') . '</th>
...
foreach ($_SESSION['FP']->LineItems as $LineItems) {
	...
	echo '<td>' . $k . '</td>
			...
			<td style=font-size:11pt><input type="text" size="12" maxlength="60" value="'.locale_number_format($LineItems->cost, $_SESSION['StandardCostDecimalPlaces']).'" name="cost" /></td>
			...
			<td><a href="'. htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') . '?Delete='.$LineItems->LineNumber.'&Application=FA2&Ref=default&Link=kofc_service"">' . _('Delete') . '</a></td>
		</tr>';
}
echo '</table>
	<br />

...
$pdf->addText($XPos-10, $YPos-25,$FontSize, _('Full Name  :').' '.$myrow['description']);
...
$pdf->RoundRectangle(
	...
	200+10+10+30,// RoundRectangle $Width.
...
$LeftOvers = $pdf->addTextWrap(280,$YPos,300,$FontSize, _('Leave Type'),'left');
$LeftOvers = $pdf->addTextWrap(420,$YPos,300,$FontSize, _('Status'),'left');

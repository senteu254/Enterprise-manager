...
$pdf->addText($XPos-10, $YPos-50,$FontSize, _('Sum of Occurences   :').''.$myrow['total']);
...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Occurence Type'));
$LeftOvers = $pdf->addTextWrap(200,$YPos,85,$FontSize, _('Occurence Date'));
$LeftOvers = $pdf->addTextWrap(300,$YPos,300,$FontSize, _('Occurence Brief'),'left');

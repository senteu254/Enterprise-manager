...
$Title = _('Crop Production');
include('includes/DefineFarmProductionClass.php');
require_once('includes/session.inc');
include('includes/SQL_CommonFunctions.inc');
include('includes/header.inc');
$ViewTopic = 'Farm';
$BookMark = 'Crop Production';
$doc=9;
$ProductionID = GetNextTransNo(390, $db);
if (isset($_GET['New'])) {
	$_SESSION['FP'] = new StockRequest();
}
...
echo '<br />
	...
	<tr>
		<th colspan="9"><h4>' . _('Details of farm Production') . '</h4></th>
	</tr>
	<tr>
		<th>' .  _('Line Number') . '</th>
...
echo '<td></h3>' . _('Enter partial') . ' <b>' . _('Company Name') . '</b>:</td>';

if (isset($_POST['source_Name'])) {
	echo '<td><input type="text"  name="source_Name" value="' . $_POST['source_Name'] . '" size="15" maxlength="18" /></td>';
} else {
	echo '<td><input type="text" name="source_Name" size="15" maxlength="18" /></td>';
	//////////////////////////////
	////////////////////////////
}

...
include('includes/DefinePVClass.php');
...
if ($_SESSION['Module']=='IRQ2') {
echo '<div id="SubMenuDiv">';
	include 'IRQv2/Switch_Board.php';
	echo '</div>';
	exit;
}
if ($_SESSION['Module']=='SEC2') {
echo '<div id="SubMenuDiv">';
	include 'SECv2/Switch_Board.php';
	echo '</div>';
	exit;
}
if ($_SESSION['Module']=='FA2') {
echo '<div id="SubMenuDiv">';
	include 'FA2/home2.php';
	echo '</div>';
	exit;
}
/////////////////////////////////////////////////////
if ($_SESSION['Module']=='CON') {
echo '<div id="SubMenuDiv">';
	include 'CO/contract_dashboard.php';
	echo '</div>';
	exit;
}
/////////////////////////////////////////////////////
if ($_SESSION['Module']=='PVM') {
echo '<div id="SubMenuDiv">';
	include 'PVP/home.php';
	echo '</div>';
	exit;
}
if ($_SESSION['Module']=='QA') {
echo '<div id="SubMenuDiv">';
	include 'QAv2/Switch_Board.php';
	echo '</div>';
	exit;
}
if ($_SESSION['Module']=='FA') {
echo '<div id="SubMenuDiv">';
	include 'MTNCEv2/Switch_Board.php';
	echo '</div>';
	exit;
}
//end

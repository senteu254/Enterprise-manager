...
<div class = "col-md-4">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						   <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>Vacation">Pending</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>VAppv">Approve</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>VDeny">Deny</a></li>
						</ul>
					</div>
				...
				?>
					...
					<tbody>
						<tr>
								...
								<td>
								<a href='<?php echo $mainlink; ?>VAppView&id=<?php echo $rec['v_id'];?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php

...
<div class = "col-md-8">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						  ...
						  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>PMApp">Approve</a></li>
				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
								...
								<td>
									<a href="<?php echo $mainlink; ?>PMLeftView&id=<?php echo  $rec['id'];?>"><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View Content" class='btn btn-info'/></a>
								</td>

	...
	<ul class="nav nav-tabs">
	  <li role="presentation"><a href="<?php echo $mainlink; ?>VacationStatus">Recently Approve</a></li>
	  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>VAll">Done Approve</a></li>
	</ul>
	<br>
<div class="container-fluid">
	<div class = "row">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="table-responsive">
					<?php
				$sql = "SELECT *,employee.emp_id as id FROM employee, vacation_log, departments,section, general_manager,managing_director,approve_hr,www_users
									...
									AND managing_director.md = '2'
									 AND vl_stat='0' ORDER BY employee.emp_id";
						$qry=DB_query($sql);
						
						
				
					
			$sql1 = "SELECT *,employee.emp_id as id FROM employee,vacation_log, departments,section,  program_head, general_manager,approve_hr,www_users
									WHERE employee.emp_id = vacation_log.emp_id 
									AND employee.id_dept = departments.departmentid
									AND section.id_sec = employee.id_sec
									AND approve_hr.hr_approve = vacation_log.hr_approve 
									...
									AND general_manager.gm  = '4' AND vl_stat='0' ORDER BY employee.emp_id";
						$qry1=DB_query($sql1);
						
				
								
						$sql2 = "SELECT *,employee.emp_id as id FROM employee, vacation_log, departments,section, section_head, program_head, chief_officer,approve_hr,www_users
									WHERE employee.emp_id = vacation_log.emp_id 
									AND employee.id_dept = departments.departmentid
									AND section.id_sec = employee.id_sec 
									AND approve_hr.hr_approve = vacation_log.hr_approve
									...
									AND  program_head.prog_head = '4' AND vl_stat='0' ORDER BY employee.emp_id";
						$qry2=DB_query($sql2);

				...
				?>
					...
					<div class="col-md-12" style="margin-top:40px">
						...
						<div class="col-md-8 col-md-offset-4">
								...
								<a href="<?php echo $mainlink; ?>PMDViewDeny&id=<?php echo $rec['mp_id'];?>"><input type='button' value='Deny' class='btn btn-primary'/></a>
								<a href="<?php echo $mainlink; ?>PMLeave"><input type = "button" value="Back" class="btn btn-default"/></a>
						</div>
					</div>
				<?php
					}

...
<div class = "col-md-4">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						  ...
						  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>VAppv">Approve</a></li>
				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
								...
								<td>
									<a href="<?php echo $mainlink; ?>VLeftView&id=<?php echo $rec['v_id'];?>"><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View Content" class='btn btn-info'/></a>
								</td>

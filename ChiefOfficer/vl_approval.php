				...
				?>
					...
					<div class="col-md-12" style="margin-top:40px">
						...
						<div class="col-md-8 col-md-offset-4">
								...
								<a href="<?php echo $mainlink; ?>VAppViewDeny&id=<?php echo $rec['v_id'];?>"><input type='button' value='Deny' class='btn btn-primary'/></a>
								<a href="<?php echo $mainlink; ?>Vacation"><input type = "button" value="Back" class="btn btn-default"/></a>
						</div>
					</div>
				<?php
					}

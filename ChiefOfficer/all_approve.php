	...
	<ul class="nav nav-tabs">
	 <li role="presentation"><a href="<?php echo $mainlink; ?>SLStatus">Recently Approve</a></li>
	  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>SLAll">Done Approve</a></li>
	</ul>
	<br>
<div class="container-fluid">
	<div class = "row">
			...
			<div class="panel-body">
				<div class="table-responsive">
					...
					//this codes is that all the approve will go to the approve submenu
						...
						$sql = "SELECT *,employee.emp_id as id FROM employee, leaves, departments,section, general_manager,managing_director,approve_hr,www_users
								 ...
								 AND sl_stat='0' ORDER BY employee.emp_id";
						$qry=DB_query($sql);
						
						
					
					
			$sql1 = "SELECT *,employee.emp_id as id FROM employee, leaves, departments,section,  program_head, general_manager,approve_hr,www_users
									WHERE employee.emp_id = leaves.emp_id 
									AND employee.id_dept = departments.departmentid
									AND section.id_sec = employee.id_sec
									AND approve_hr.hr_approve = leaves.hr_approve 
									...
									AND general_manager.gm  = '4' AND sl_stat='0' ORDER BY employee.emp_id";
						$qry1=DB_query($sql1);
						
				
								
						$sql2 = "SELECT *,employee.emp_id as id FROM employee, leaves, departments,section, section_head, program_head, chief_officer,approve_hr,www_users
									WHERE employee.emp_id = leaves.emp_id 
									AND employee.id_dept = departments.departmentid
									AND section.id_sec = employee.id_sec
									AND approve_hr.hr_approve = leaves.hr_approve
									...
									AND  program_head.prog_head = '4' AND sl_stat='0' ORDER BY employee.emp_id";
						$qry2=DB_query($sql2);
					?>

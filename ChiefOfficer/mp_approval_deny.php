...
<div class = "col-md-8">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						  <li role="presentation"><a href="<?php echo $mainlink; ?>PMLeave">Pending</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>PMApp">Approve</a></li>
						  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>PMDeny">Deny</a></li>
						</ul>
					</div>
				</div>
<div class="container-fluid">
				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
								...
								<td>
								<a href='<?php echo $mainlink; ?>PMDenyView&id=<?php echo $rec['mp_id'];?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View Content" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php

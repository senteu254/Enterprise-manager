...
<div class = "col-md-4">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						  ...
						  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>SickLeave">Pending</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>SickLeaveAppv">Approve</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>SickLeaveDeny">Deny</a></li>
						</ul>
					</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="table-responsive">
					<?php
			//get all 1 w/c is pending under the table of chiefofficer and get all information under to its program head 
				//per specific  department
				...
				?>
					...
					<tbody>
						<tr>
								...
								<td>
								<a href='<?php echo $mainlink; ?>SLPendingView&id=<?php echo $rec['leaveid']; ?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php

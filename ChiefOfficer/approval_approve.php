...
<div class = "col-md-4">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						  ...
						  <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>SickLeaveAppv">Approve</a></li>
				...
				<div class="table-responsive">
					...
					<tbody>
						<tr>
								...
								<td>
									<a href='<?php echo $mainlink; ?>SLAppvView&id=<?php echo $rec['leaveid']; ?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>

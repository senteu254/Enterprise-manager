...
<div class = "col-md-8">
				...
				<div class = "row">	
					...
					<ul class="nav nav-tabs">
						   <li role="presentation" class="active"><a href="<?php echo $mainlink; ?>PMLeave">Pending</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>PMApp">Approve</a></li>
						  <li role="presentation"><a href="<?php echo $mainlink; ?>PMDeny">Deny</a></li>
						</ul>
					</div>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<?php	
						...
						$sql = "SELECT *,employee.emp_id as id  FROM employee ,mp_log,chiefofficer,section,departments, approve_hr,section_head,chief_officer
				...
				?>
					...
					<tbody>
						<tr>
								...
								<td>
								<a href='<?php echo $mainlink; ?>PMAppView&id=<?php echo $rec['mp_id'];?>'><input type='button' value='View' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
							</tr>
					</tbody>
				<?php

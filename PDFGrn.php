...
if ($NoOfGRNs >0){
$myr = DB_fetch_array($GRNResult1);
//DB_data_seek($GRNResult);
		...
		*/
		...
		if ($ControlledRow[0]==1) { /*Then its a controlled item */
			...
			while ($SerialStockMoves = DB_fetch_array($GetStockMoveResult)){
				$LeftOvers = $pdf->addTextWrap($FormDesign->Data->Column1->x+30,$Page_Height-$YPos,$FormDesign->Data->Column1->Length,$FormDesign->Data->Column1->FontSize, _('Lot/Serial:'),'right');
				$LeftOvers = $pdf->addTextWrap($FormDesign->Data->Column2->x+50,$Page_Height-$YPos,$FormDesign->Data->Column2->Length,$FormDesign->Data->Column2->FontSize, $SerialStockMoves['serialno']);
				$LeftOvers = $pdf->addTextWrap($FormDesign->Data->Column4->x,$Page_Height-$YPos,$FormDesign->Data->Column4->Length,$FormDesign->Data->Column4->FontSize, $SerialStockMoves['moveqty'],'right');
				$YPos += $line_height;

...
$YPos -= 55;
$XPos = 40;
$LeftOvers = $pdf->addTextWrap($Left_Margin,$YPos,100,$FontSize, _('Property type'));
$LeftOvers = $pdf->addTextWrap(150,$YPos,85,$FontSize, _('Description'));
$LeftOvers = $pdf->addTextWrap(300,$YPos,300,$FontSize, _('issue Date'),'left');
$LeftOvers = $pdf->addTextWrap(380,$YPos,415,$FontSize, _('Return Date'),'left');
$LeftOvers = $pdf->addTextWrap(460,$YPos,530,$FontSize, _('Estimate Cost'),'left');

...
require_once('includes/session.inc');
							...
							$view = (isset($_GET['Ref']) && $_GET['Ref'] != '') ? $_GET['Ref'] : '';
								switch ($view) {
								case 'Create-Request' :
									$title="Create a Transport Request";
									$subtitle ='Create New Transport Request';
								...
								case 'Follow-Up' :
									...
									$content=$path.'Follow_Up_Transport.php';	
									$class2= 'class="active"';	
									break;
							...
							INNER JOIN irq_transport e ON a.requestid = e.TransportID

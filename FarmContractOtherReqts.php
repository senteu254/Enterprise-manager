...
if (!isset($_SESSION['Contract'.$identifier])){
	header('Location:' . $RootPath . '/FarmContract.php');
	exit;
}
...
if (isset($_POST['BackToHeader'])){
	...
	echo '<br />';
	prnMsg(_('You should automatically be forwarded to the Contract page. If this does not happen perhaps the browser does not support META Refresh') .	'<a href="' . $RootPath . '/FarmContract.php?identifier='.$identifier . '">' . _('click here') . '</a> ' . _('to continue'),'info');

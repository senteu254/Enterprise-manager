...
?>
		...
		echo '<br />';
		echo ' <a href="IRQ_PDFGatepassPortrait.php?id='.$LID.'" target="_blank"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print Gate Pass</button></a>';	
		echo '<div class="line"> ';
		...
		echo '<br />';
            ...
            <div class="box-footer">
			  <a href="IRQ_PDFGatepassPortrait.php?id=<?php echo $LID; ?>" target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Print Gate Pass</button></a>
            </div>
			<br></br>
			<?php

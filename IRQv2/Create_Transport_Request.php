	...
	$SQL="INSERT INTO irq_request (requestid,
		...
		echo _('<div class="alert alert-success alert-dismissible">
			...
			echo '<div class="alert alert-success alert-dismissible">
                <h4><i class="icon fa fa-check"></i> Success</h4>Transport Request No. '.$RequestNo.' has been created and forwarded for authoritation</div>';
			}
		/*--------------------------------------------------------------------------------------------------*/
		
		}else{
		echo _('<div class="alert alert-success alert-dismissible">
                <h4><i class="icon fa fa-check"></i> Success</h4>Transport Request No. '.$RequestNo.' has been saved as a Draft.</div>');
		}
}
}
...
<table class="selection" style="width:70%;">
  <tr>
    <th colspan="4"><center><h4>Transport Requisition Proformae</h4></center></th>
  </tr>
  <tr>
    <th colspan="4">
	<div align="center">

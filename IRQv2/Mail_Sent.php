...
$search="";
						...
						$statement = " irq_request z 
							...
							WHERE draft=0 AND ".$search." z.initiator='".$_SESSION['UserID']."'";
	...
	?>
              ...
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a href="index.php?Application=IRQ2&Link=Sent"><button type="button" title="Refresh" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
				</div>
				<div class="col-xs-4">
				...
				<div class="btn-group">
				<?php
				echo pagination_inbox($sqlforPages,$per_page,$page,$url='?Application=IRQ2&Link=Sent&');
				?>
                  </div>
                  <!-- /.btn-group -->
                </div>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <table style="width:100%" class="table table-hover table-striped">
				 ...
				 if($num_rows>0){
					...
					$RType = 'SentReadTransport';
					}elseif($row['doc_id']==5 || $row['doc_id']==6){
					$RType = 'SentReadMaintenance';
					}elseif($row['doc_id']==7 || $row['doc_id']==8){
					$RType = 'SentReadGatePass';
					}
                  echo '<tr>

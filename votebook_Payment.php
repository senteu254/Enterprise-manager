<?php
  ...
  .even{background-color:#CCCCCC;} 
	...
	$result=DB_query("SELECT a.lpo_No,             	 
	 ...
	 $totalAlloc=($test['allocated_Fund']+ $test['total_suplmentary']);
	...
	echo"<td><center>" .locale_number_format($test['total_suplmentary'],2)."</font></center></td>"; 
	echo"<td><center>".locale_number_format($totalAlloc,2). "</center></td>";
	echo"<td><center>".locale_number_format($test['commitments'],2). "</center></td>";
